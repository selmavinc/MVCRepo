...
using DBFirstAPIWebApplication.Models;

namespace DBFirstAPIWebApplication.Controllers
{
    ...
    public class DepartmentsController : ControllerBase
    {
        ...
        public DepartmentsController(DBFirstAppContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Department>> PostDepartment(Department department)
        {
          if (_context.Departments == null)
          {
              return Problem("Entity set 'DBFirstAppContext.Departments'  is null.");
          }
