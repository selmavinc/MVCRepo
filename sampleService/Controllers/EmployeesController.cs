...
namespace sampleService.Model
{
    ...
    {
        private readonly sampleServiceContext _context;

        public EmployeesController(sampleServiceContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Employee>> PostEmployee(Employee employee)
        {
          if (_context.Employee == null)
          {
              return Problem("Entity set 'sampleServiceContext.Employee'  is null.");
          }
